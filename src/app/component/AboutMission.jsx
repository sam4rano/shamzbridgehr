...
const AboutMission = () => {
  return (
    <section className="w-full">
      {/* Hero Section */}
      <div className="relative w-full before:content-[''] before:absolute before:inset-0 before:bg-gray-500 before:opacity-70">
        <Image
          src={director}
        ...
        />
        {/* Text Overlay */}
        <div className="absolute inset-0 flex items-center align-middle justify-center p-4 sm:p-2  rounded-lg">
          <div className="flex flex-col items-center justify-center align-middle">
            <h3 className="text-5xl sm:text-3xl font-bold text-white sm:text-center ">
              Join us on our journey
            </h3>
            <p className="text-xl font-bold sm:text-base text-white mt-2 sm:text-center">
      ...
      <div className=" bg-white py-12 sm:py-4">
        <div className="max-w-6xl mx-auto flex flex-col items-center gap-12 px-6 lg:px-0">
          <article className="text-center max-w-2xl">
            <h2 className="text-4xl font-bold text-blue-600 sm:text-2xl sm:pb-6" >
              Our Vision and Mission
            </h2>
            <p className="text-xl mt-4 text-gray-700 sm:mt-0">
          ...
          <div className="flex flex-col md:flex-row gap-12 sm:gap-6 w-full max-w-5xl">
            {/* Mission */}
            <article className="flex-1 bg-blue-50 p-8 sm:p-4 rounded-lg shadow-md">
              <h3 className="text-3xl font-bold text-blue-600 sm:text-center sm:text-xl">Our Mission</h3>
              <p className="mt-4 text-lg text-gray-700 sm:text-center">
            ...
            {/* Vision */}
            <article className="flex-1 bg-blue-50 p-8 sm:p-4 rounded-lg shadow-md">
              <h3 className="text-3xl font-bold text-blue-600 sm:text-center sm:text-xl">Our Vision</h3>
              <p className="mt-4 text-lg text-gray-700 sm:text-center">
